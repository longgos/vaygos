package com.ways.utils.utils.cache.redis;
...
public class RedisSessionUtils {
	 ...
	 * @return
	 */
	public static boolean saveSession(String sessionId,
			Map<String, Object> sessionObj, Integer seconds) {
		boolean result = false;
		try {
			if (seconds != null) {
				result = RedisUtils.save(sessionId, sessionObj, seconds);
			} else {
				result = RedisUtils.save(sessionId, sessionObj,
